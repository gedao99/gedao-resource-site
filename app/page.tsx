...
export default function Home() {
  ...
  // 页面加载校验弹窗
  useEffect(() => {
    const skipped = localStorage.getItem('skippedAIInvite');
    if (!skipped) setShowInviteModal(true);
  }, []);

  // 同意加入：跳转到你的QQ群链接
  const handleJoinGroup = () => {
    window.open("https://qm.qq.com/q/KPkPCBv6MK", "_blank");
    localStorage.setItem('skippedAIInvite', 'true');
    ...
    <div className="all">
        ...
        <div className="invite-modal-overlay">
          <div className="invite-modal">
            ...
            <div className="invite-modal-content">
              ...
              <p>不用怕零基础，也不用怕没人教、踩坑走弯路。<br/>我们的免费交流群，为你提供：<br/>✅ 实用AI工具分享与使用技巧<br/>✅ 新手入门教程与避坑指南<br/>✅ 同频伙伴交流、互相答疑</p>
      ...
      <style jsx global>{`
        *{margin:0;padding:0;box-sizing:border-box;font-family:Microsoft Yahei}
        ...
        .invite-modal-title{
          font-size:22px;color:#1e40af;margin-bottom:20px;
        }
        .invite-modal-content{
          text-align:left;
          color:#1e3a8a;line-height:1.8;margin-bottom:30px;
          font-size:15px;
        }

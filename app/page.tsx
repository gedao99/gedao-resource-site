...
{
  title: "AI代写教案，一单100500+，单子做不完，AI写作快速变现，小白可做 超简单！",
  type: "app",
  time: "2026-05-01",
  linkUrl: "https://pan.quark.cn/s/5a3ab2ad1726",
  desc: "想找个正经副业？没特长、没技术、不想求人引流的看过来。这个项目只需会用电脑，用AI工具就能干。我们直接给你对接好的渠道，不用自己找客户，上线就能接单。每天抽出2小时，按部就班就能写完。按现在的单量，一天赚几百块是常态，收益绝对比你打工稳。别整那些虚的，只要你肯花时间去干，结果一定看得见。",
  top: false,
}, // ✅ 逗号正确，{}位置正确
{
...
}, // ✅ 逗号正确，{}位置正确
{
  ...
  desc: "本课程为AI漫剧硬核实战课，覆盖行业认知、核心技能拆解与二次元动态漫案例实战，整合多款AI工具教学，建立工业化SOP出片流程，解决角色脸盲、动作生硬、画质廉价等痛点，助力学员实现影视级制作与商业变现。",
  top: false,
}, // ✅ 逗号正确，{}位置正确
{
  ...
  desc: "东健AI摄影商业视觉MJ+SD训练营中文教程|88GB",
  top: false,
}, // ✅ 逗号正确，{}位置正确
{
  ...
  desc: "专注成年人行业资格证考试资料变现，蓝海考题赛道，覆盖多行业备考资料，全套小白可学实操流程，短平快变现，单天可赚500-2000元。",
  top: false,
}, // ✅ 逗号正确，{}位置正确
{
  ...
  desc: "AI全自动生成教辅资料+笔记图，无需手动制作，小红书店铺自动发货，蓝海长期副业，小白易上手，账号越后期收益越高。",
  top: false,
}, // ✅ 逗号正确，{}位置正确
{
  ...
  desc: "本课程是闲鱼付费社群实战教程，专注无货源闲鱼卖货变现，包含新手手册、视频课、货源对接、选品、群内诊断、高级群团队分红等全套服务，教你利用差价与佣金实现一部手机稳定副业增收。",
  top: false,
}, // ✅ 逗号正确，{}位置正确
    {
  title: "4K影视",
